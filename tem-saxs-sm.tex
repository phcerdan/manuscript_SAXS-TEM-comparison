...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[journal=bomaf6,manuscript=article]{achemso}
\setkeys{acs}{articletitle=true}
%\usepackage[super,sort&compress,comma]{natbib} 
\usepackage[version=3]{mhchem}
\renewcommand*{\thefootnote}{\fnsymbol{footnote}} % For footnotes to be symbols
...
\alsoaffiliation{The MacDiarmid Institute for Advanced Materials and Nanotechnology, Wellington, New Zealand.}
\alsoaffiliation{Riddet Insitute, Palmerston North, New Zealand.}
%\email{p.hernandezcerdan@massey.ac.nz}
\author{Bradley W. Mansel}
\affiliation{Institute of Fundamental Sciences, Massey University, Palmerston North, New Zealand.}
\alsoaffiliation{The MacDiarmid Institute for Advanced Materials and Nanotechnology, Wellington, New Zealand.}
\author{Andrew Leis}
\affiliation{Bio21 Institute, The University of Melbourne, Australia.}
\author{Leif Lundin}
\affiliation{RISE, Agrifood and Bioscience, Gothenburg, Sweden}
\author{Martin A.K. Williams}
\affiliation{Institute of Fundamental Sciences, Massey University, Palmerston North, New Zealand.}
\alsoaffiliation{The MacDiarmid Institute for Advanced Materials and Nanotechnology, Wellington, New Zealand.}
\email{m.williams@massey.ac.nz}

\title{On the Structural Analysis of Polysaccharide-Networks by Transmission Electron-Microscopy: Comparison with SAXS}
\begin{document}
...
\begin{figure*}[!ht]
    \includegraphics[width=0.32\textwidth]{pectin1_1045_homogeneous_scalebar_label.jpeg}
    \hspace{0.5pt}
    % \includegraphics[width=0.325\textwidth]{carrageenan_K_Montage_832_scalebarFixed_label.jpeg}
    \includegraphics[width=0.32\linewidth]{carrageenan_K_Montage_833_scalebarFixed_normalized_label.jpeg}
    \hspace{0.5pt}
    \includegraphics[width=0.32\textwidth]{carrageenan_Na_Montage_851_scalebar_label.jpeg}
...
\begin{figure}[H]
    \centering
    \noindent\includegraphics[width=0.75\linewidth]{./figs-tikz/saxs_fit.pdf}
...
\begin{figure}[!ht]
    \centering
    \noindent\includegraphics[width=0.95\linewidth]{./figs-tikz/saxs-tem-merged.pdf}
...
\begin{figure*}[!ht]
  \begin{minipage}{0.32\textwidth}
    ...
    \noindent\includegraphics[width=\linewidth]{./figs-tikz/saxs-tem-TV-pectin.pdf}\label{fig:denoise_pectin}
  \end{minipage}
  \begin{minipage}{0.32\textwidth}
    % \includegraphics[width=\linewidth]{./figs-tikz/saxs-tem-TV-carK.svg}\label{fig:denoise_carrK_image}

    \includegraphics[width=\linewidth]{./figs-tikz/saxs-tem-TV-carK.pdf}\label{fig:denoise_carrK}
  \end{minipage}
  \begin{minipage}{0.32\textwidth}
    % \includegraphics[width=\linewidth]{./figs-tikz/saxs-tem-TV-carNa.svg}\label{fig:denoise_carrNa_image}

    \includegraphics[width=\linewidth]{./figs-tikz/saxs-tem-TV-carNa.pdf}\label{fig:denoise_carrNa}
  \end{minipage}
  \caption{
...
\begin{figure*}[!ht]
  \begin{minipage}{0.32\textwidth}
    \noindent\includegraphics[width=\linewidth]{./images/figure_denoised/pectin_crop_tile01_500x500_900_1900_label.png}\label{fig:denoise_comparison_pectin_original}
  \end{minipage}
  \begin{minipage}{0.32\textwidth}
    \includegraphics[width=\linewidth]{./images/figure_denoised/pectin_TV_lam015_crop_tile01_500x500_900_1900_label.png}\label{fig:denoise_comparison_pectin_TV}
  \end{minipage}
  \begin{minipage}{0.32\textwidth}
    \includegraphics[width=\linewidth]{./images/figure_denoised/pectinPortillaSigma28_crop_tile01_500x500_900_1900_label.png}\label{fig:denoise_comparison_pectin_wavelet}
  \end{minipage}
...
\begin{figure}[!ht]
    \centering
    \noindent\includegraphics[width=0.7\linewidth]{fibreAppTrackingImage_subplot.pdf}
...
\begin{tocentry}
\includegraphics{graph_toc_resized.png}
\end{tocentry}
\bibliography{bibliography_abrev}
